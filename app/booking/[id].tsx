...
import { useBookings, formatDate, formatPrice, Player } from "@/context/BookingsContext";
  ...
  return (
    ...
    >
      <View style={styles.playerLeft}>
        <View style={[styles.avatarMini, { backgroundColor: player.paid ? "rgba(46,204,113,0.15)" : Colors.surface }]}>
